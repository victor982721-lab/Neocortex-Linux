...
def run_video_search(args: argparse.Namespace) -> int:
    from .video_state import search_video_state
...
def run_video_status(args: argparse.Namespace) -> int:
    from .video_state import video_state_status
...
def run_video_doctor(args: argparse.Namespace) -> int:
    from .video_frames import resolve_video_ffmpeg
    from .video_probe import resolve_video_ffprobe
