...
EXPECTED_SOURCES = {
    ...
    "STATE_RESET_API_SCHEMA": "neocortex.api.state_reset",
    "STATE_RESET_CONFIRMATION": "neocortex.api.state_reset",
    "STATE_RESET_SCHEMA": "neocortex.api.state_reset",
    "STATE_RESET_SCOPES": "neocortex.api.state_reset",
    "RESET_STATE_CONFIRMATION": "neocortex.api.state_reset",
    "StateResetEntry": "neocortex.api.state_reset",
    "StateResetPlan": "neocortex.api.state_reset",
    "StateResetResult": "neocortex.api.state_reset",
    "StateResetScope": "neocortex.api.state_reset",
    "StateResetTarget": "neocortex.api.state_reset",
    "apply_state_reset": "neocortex.api.state_reset",
    "execute_state_reset": "neocortex.api.state_reset",
    "plan_state_reset": "neocortex.api.state_reset",
    "reset_state": "neocortex.api.state_reset",
    "state_reset_payload": "neocortex.api.state_reset",
