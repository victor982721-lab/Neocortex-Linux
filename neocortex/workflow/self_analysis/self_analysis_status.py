...
from neocortex.workflow.self_analysis.self_analysis_freshness import (
    FreshnessFences,
    JournalStatus,
    SelfAnalysisFreshness,
    evaluate_self_analysis_freshness,
)
from neocortex.workflow.self_analysis.self_analysis_manifest import (
...
_preserve_legacy_module(globals(), "_04_Nucleo_Operativo.self_analysis_status")
