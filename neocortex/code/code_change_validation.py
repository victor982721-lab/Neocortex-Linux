...
from neocortex.code.validation_supply import (
...
CODE_CHANGE_VALIDATION_POLICY = "local-linux-diff-aware-validation-v13"
...
_FULL_SUITE_PREFIXES = (
    ...
    "neocortex/code/code_architecture_contracts.py",
    "neocortex/code/contracts/target_projection.py",
    "neocortex/code/external_architecture_",
    "neocortex/code/contracts/target_registry.py",
