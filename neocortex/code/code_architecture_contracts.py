...
_INTERFACE_CORE_ALLOWLIST = (
    ...
    ("neocortex.interface.protocol.worker", "neocortex.api.cli.cli_config"),
    ("neocortex.interface.protocol.worker", "neocortex.api.cli.cli_parser"),
...
_NEOCORTEX_CORE_UI_ALLOWLIST = (
    ...
    ("neocortex.capabilities.formats.archive.route", "neocortex.runtime.control.cancellation"),
    ...
    ("neocortex.capabilities.formats.image.route", "neocortex.persistence.framework_route_state"),
    ...
    ("neocortex.capabilities.formats.pdf.pdf_route", "neocortex.persistence.framework_route_state"),
    ("neocortex.capabilities.formats.pdf.pdf_route", "neocortex.persistence.framework_state_writer"),
    ...
    ("neocortex.capabilities.formats.video.frames", "neocortex.runtime.control.cancellation"),
    ("neocortex.capabilities.formats.video.models", "neocortex.foundation.processing_provenance"),
    ("neocortex.capabilities.formats.video.probe", "neocortex.runtime.control.bounded_subprocess"),
